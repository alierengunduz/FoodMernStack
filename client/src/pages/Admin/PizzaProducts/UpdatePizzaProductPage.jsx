...
const UpdatePizzaProductPage = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [categoriesResponse, productsResponse] = await Promise.all([
          fetch(`${apiUrl}/api/pizzacategories`),
          fetch(`${apiUrl}/api/pizzaproduct/${productId}`),
        ]);
  ...
  const onFinish = async (values) => {
    setLoading(true);
    try {
      const resnpose = await fetch(`${apiUrl}/api/pizzaproduct/${productId}`, {
        method: "PUT",
        headers: {
...
export default UpdatePizzaProductPage;
